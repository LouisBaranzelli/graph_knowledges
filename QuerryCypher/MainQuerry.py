...
from WhereQuerry import WhereQuerry, ConditionalPattern
from PatternQuerry import NodeNeo4j, PatternQuerry, Variable, PropertyNode, Property, PatternSet
...
class SetQuerry(MatchQuerry):
    def __init__(self, inputs: List[PatternQuerry | NodeNeo4j], setValue: PatternSet, outputs: List[Variable | PropertyNode] = None, where: WhereQuerry = None):
    ...
    def __str__(self) -> str:
        ...
        ret: str = f"RETURN ({', '.join([str(e.getName()) for e in self.getOutputs()])})"
